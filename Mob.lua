...
function boxBase:Update()
    ...
    if ESP.Names then
        ...
        if Vis5 then
            ...
            self.Components.Health.Text = "[HP: " .. math.floor(self.Player.Character.Humanoid.Health + 0.5) .. "/" .. math.floor(self.Player.Character.Humanoid.MaxHealth + 0.5) .. "] [" .. math.floor((self.Player.Character.Humanoid.Health / self.Player.Character.Humanoid.MaxHealth) * 100) .. "%]"
